...
export const ruContent: LandingContent = {
  ...
  features: {
    ...
    items: [
      { num: "01", icon: Users, title: "Семейный доступ без регистрации", desc: "Поделитесь уникальной ссылкой с родственниками. Любой может добавить воспоминания, фото и истории — без создания аккаунта" },
      { num: "02", icon: CalendarHeart, title: "Биография и жизненный путь", desc: "Имя, даты рождения и ухода, место жительства, образование, профессия — создайте полноценную биографическую страницу" },
      { num: "03", icon: ImagePlay, title: "Медиаархив: фото, видео, аудио", desc: "Загружайте фотографии, видеозаписи, голосовые сообщения и документы. Всё хранится надёжно и доступно всей семье" },
      { num: "04", icon: MessageCircleHeart, title: "ИИ-чатбот на основе воспоминаний", desc: "Загрузите тексты, письма, дневники — ИИ научится отвечать так, как отвечал бы ваш близкий" },
      { num: "05", icon: Bot, title: "ИИ-аватар из фотографий", desc: "Загрузите несколько фотографий — сервис создаст анимированный видеоаватар, который двигается и говорит голосом вашего близкого", comingSoon: true },
      { num: "06", icon: Mic2, title: "Синтез голоса", desc: "Загрузите аудиозаписи — ElevenLabs клонирует голос. Аватар будет говорить настоящим голосом вашего близкого", comingSoon: true },
    ],
  },
  testimonials: {
    badge: "Отзывы",
